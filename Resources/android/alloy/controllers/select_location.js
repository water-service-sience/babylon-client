function Controller() {
    ...
    $.__views.select_location.add($.__views.__alloyId213);
    onOkClicked ? $.__views.__alloyId213.addEventListener("click", onOkClicked) : __defers["$.__views.__alloyId213!click!onOkClicked"] = true;
    ...
    __defers["$.__views.__alloyId213!click!onOkClicked"] && $.__views.__alloyId213.addEventListener("click", onOkClicked);
    _.extend($, exports);
}
