function Controller() {
    ...
    $.__views.edit_land.add($.__views.__alloyId16);
    onOkClicked ? $.__views.__alloyId16.addEventListener("click", onOkClicked) : __defers["$.__views.__alloyId16!click!onOkClicked"] = true;
    ...
    $.__views.edit_land.add($.__views.__alloyId17);
    onDeleteClicked ? $.__views.__alloyId17.addEventListener("click", onDeleteClicked) : __defers["$.__views.__alloyId17!click!onDeleteClicked"] = true;
    ...
    __defers["$.__views.__alloyId16!click!onOkClicked"] && $.__views.__alloyId16.addEventListener("click", onOkClicked);
    __defers["$.__views.__alloyId17!click!onDeleteClicked"] && $.__views.__alloyId17.addEventListener("click", onDeleteClicked);
    _.extend($, exports);
}
