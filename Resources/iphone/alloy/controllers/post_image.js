function Controller() {
    ...
    $.__views.post_image.add($.__views.__alloyId94);
    ...
    $.__views.__alloyId94.add($.__views.title);
    $.__views.photo = Ti.UI.createImageView({
        width: "90%",
        height: "40%",
        id: "photo"
    });
    $.__views.__alloyId94.add($.__views.photo);
    ...
    $.__views.__alloyId95.add($.__views.category);
    ...
    $.__views.__alloyId95.add($.__views.select_category);
    ...
    $.__views.goodness.setParent($.__views.__alloyId94);
    ...
    $.__views.__alloyId94.add($.__views.comment);
    ...
    $.__views.__alloyId98.add($.__views.post);
    ...
    $.__views.__alloyId98.add($.__views.recapture);
    ...
    $.__views.__alloyId94.add($.__views.gallery);
